  ...
  Tweetfilter.prototype.streamswitched = function() {
    if (!this.cs.$node.data('_tfbound')) {
      this.cs.$node.delegate('div.stream-item', 'click', (function() {return this.tweetclick();}).bind(this))
                   ...
                   .delegate('p.js-tweet-text', 'mousedown', (function(e) {return this.tweettextmousedown(e);}).bind(this))
                   .delegate('p.js-tweet-text', 'mouseup click', (function(e) {return this.tweettextmouseup(e);}).bind(this))
